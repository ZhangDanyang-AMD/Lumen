...
@_torch_custom_op_wrapper(
    "transformer_light::attention_aiter_csrc_forward_impl", mutates_args=(), device_types="cuda"
)
...
@_torch_custom_op_wrapper(
    "transformer_light::attention_aiter_csrc_backward_impl", mutates_args=("dq", "dk", "dv"), device_types="cuda"
)
