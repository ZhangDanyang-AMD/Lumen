...
__all__ = ["TransformerLightAttention"]

class TransformerLightAttention(torch.nn.Module):
    def __init__(
        self,
        dropout_p=0.0,
        softmax_scale=None,
        ...
        assert not (
            quant_type is not None and backend_type == "aiter"
        ), "When quant_type is not None, attention_type cannot be 'aiter'."
