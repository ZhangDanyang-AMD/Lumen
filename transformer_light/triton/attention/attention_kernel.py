...
DEBUG = os.environ.get("TRANSFORMER_LIGHT_ATTENTION_TRITON_AMD_DEBUG", "0").lower() in ("1", "true", "yes")
PERF = os.environ.get("TRANSFORMER_LIGHT_ATTENTION_TRITON_AMD_PERF", "0").lower() in ("1", "true", "yes")
USE_FP8E5M2_BWD = os.environ.get("TRANSFORMER_LIGHT_ATTENTION_USE_FP8E5M2_BWD", "0").lower() in ("1", "true", "yes")
