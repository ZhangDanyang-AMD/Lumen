...
from lumen.modules.megatron_layer_patches import (
    _NORM_ATTRS,
    MegatronCompatibleTLLayerNorm as _MegatronCompatibleTLLayerNorm,
    MegatronCompatibleTLNorm as _MegatronCompatibleTLNorm,
    MegatronCompatibleTLRMSNorm as _MegatronCompatibleTLRMSNorm,
    enable_fp8_for_parallel_linear,
    patch_all_norms as _patch_all_norms,
    patch_core_attention as _patch_core_attention,
    patch_cross_entropy as _patch_cross_entropy,
    patch_fused_swiglu_mlp as _patch_fused_swiglu_mlp,
    patch_layernorm as _patch_layernorm,
    patch_mla_attention as _patch_mla_attention,
    patch_norms_in_spec as _patch_norms_in_spec,
    patch_rmsnorm as _patch_rmsnorm,
)
