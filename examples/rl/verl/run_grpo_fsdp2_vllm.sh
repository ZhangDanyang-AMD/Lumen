...
###############################################################################
#
# VERL + Lumen GRPO launcher (FSDP2 actor + vLLM rollout, 8x MI300X)
#
# Usage:
#   bash examples/rl/verl/run_grpo_fsdp2_vllm.sh
#
# Same as run_grpo_fsdp2.sh but uses vLLM for rollout instead of SGLang.
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-grpo-fsdp2-vllm}"
...
echo "=== VERL + Lumen GRPO — FSDP2 + vLLM rollout ==="
