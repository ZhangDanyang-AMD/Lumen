...
###############################################################################
#
# VERL + Lumen GRPO launcher (Megatron actor + SGLang rollout, 8x MI300X)
#
# Usage:
...
# actor/reference and SGLang for rollout generation.
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-grpo-megatron-sglang}"
