...
Launch:
  accelerate launch --config_file ddp_8gpu.yaml \
    ...
    examples/rl/trl/benchmark/llama-3.1-8b/train_grpo_lumen_fp8.py --max-steps 1000
"""
...
OUTPUT_DIR = os.environ.get(
    "OUTPUT_DIR",
    "/workspace/Lumen/outputs/benchmark/llama-3.1-8b/lumen_fp8_dynamic",
)
...
def main():
    ...
    print(f"[fp8_dynamic] Model={MODEL_PATH}  GPUs={num_gpus}  per_device_bs={per_device_bs}  "
