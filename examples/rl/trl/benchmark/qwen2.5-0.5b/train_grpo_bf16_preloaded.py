"""Apple-to-apple BF16 baseline (pre-loaded model).
...
model_init_kwargs.  This is the control for the FP8 dynamic-scaling run.

Launch:
  OUTPUT_DIR=... accelerate launch --config_file ddp_8gpu.yaml \
    --num_processes 8 --main_process_port 29500 \
    examples/rl/trl/benchmark/qwen2.5-0.5b/train_grpo_bf16_preloaded.py --max-steps 1000
"""
...
OUTPUT_DIR = os.environ.get(
    "OUTPUT_DIR",
    "/workspace/Lumen/outputs/benchmark/qwen2-0.5b-exact/bf16_preloaded",
)
...
def main():
    ...
    print(f"[bf16_preloaded] GPUs={num_gpus}  per_device_bs={per_device_bs}  "
