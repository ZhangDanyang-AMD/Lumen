---
name: lumen-RL
description: "Guide for choosing and executing Lumen RL integrations on AMD GPUs. Recommends the TRL-first then VERL landing path, explains why OpenRLHF and DeepSpeedChat are not first targets, covers DeepSpeed support difficulty, and provides execution checklists for TRL + Lumen + FSDP/FSDP2 and VERL + Lumen FSDP/Megatron."
---
