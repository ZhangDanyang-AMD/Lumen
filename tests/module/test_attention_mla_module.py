...
class TestCpParamBundleUseSdma:
    ...
    @mock.patch("lumen.modules.attention_mla.divide", side_effect=lambda a, b: a // b)
    @mock.patch("lumen.modules.attention_mla.MegatronModule.__init__", _patched_megatron_init)
    @mock.patch("lumen.modules.attention_mla.get_args", return_value=_make_args())
    @mock.patch("lumen.modules.attention_mla.parallel_state")
    def test_cp_param_bundle_includes_use_sdma(self, mock_ps, *_):
        ...
        with mock.patch("lumen.modules.attention_mla._use_sdma_from_args", return_value=True), mock.patch(
            "lumen.modules.attention_mla.attention"
        ) as mock_attn:
